	...
	const jsonLd = [
		{
			...
			"@type": "Service",
			name: `AI Towing Dispatch - ${metro.metro}`,
			description: `24/7 AI-powered towing dispatch service for ${metro.cities.join(", ")} and the greater ${metro.metro} area.`,
			provider: {
				"@type": "Organization",
				name: "tow.center",
			...
			serviceType: "Towing Dispatch Service",
			offers: {
				"@type": "Offer",
				price: "49.00",
				priceCurrency: "USD",
			...
			itemListElement: [
				{
					...
					position: 1,
					name: "Home",
					item: "https://tow.center",
				},
				{
					"@type": "ListItem",
					position: 2,
					name: "Service Areas",
					item: "https://tow.center/service-areas",
				},
				{
					"@type": "ListItem",
					position: 3,
					name: metro.metro,
					item: `https://tow.center/service-areas/${metro.slug}`,
				},
			],
		},
	];
					...
					<div className="container mx-auto px-4">
						<div className="max-w-2xl mx-auto text-center">
							...
							<p className="text-muted-foreground mb-8">
								...
								AI-powered dispatch. Get 3 months free, then just $49/month
								locked in for life.
							</p>
